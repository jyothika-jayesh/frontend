     ...
     <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
            ...
            <input
             ...
             onChange={(e)=> setProductData({
                ...productData,
                colors: e.target.value.split(",").map((color)=>size.trim()),
            })
        }
             className="w-full border border-gray-300 rounded-md p-2"
...
<button type="submit" className="w-full bg-green-500 text-white py-2 rounded-md hover:bggree6 transition-colors">Update Product</button>
     </form>
     </div>
     );
};
